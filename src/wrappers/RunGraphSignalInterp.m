...
for r = 1:sPreset.R
    ...
    if sPreset.b_compareMethods
        [tSigCnvrtRec(:,:,r,2), tSigCnvrtInt(:,:,r,2), tTrainTime(r,2), tIntTime(r,2)] = InterpGraphSignalRepThm(sPlotParams, sPreset, sDataset);
        [tSigCnvrtRec(:,:,r,3), tSigCnvrtInt(:,:,r,3), tTrainTime(r,3), tIntTime(r,3)] = InterpGraphSignalPesenson(sPlotParams, sPreset, sDataset);
        [tSigCnvrtRec(:,:,r,4), tSigCnvrtInt(:,:,r,4), tTrainTime(r,4), tIntTime(r,4)] = InterpGraphSignalNystrom(sPlotParams, sPreset, sDataset);
...
[mAccRec, mAccStdRec, mAccInt, mAccStdInt] = InterpGraphSignalsMetrics(sPlotParams, sPreset, b_interpEigenvecs, tSigCnvrtRec, tSigCnvrtRecRef, tSigCnvrtInt, tSigCnvrtIntRef, tTrainTime, tIntTime);
sResults = SaveResults(sPreset, sPlotParams, tSigCnvrtRec, tSigCnvrtInt, tSigCnvrtRecRef, tSigCnvrtIntRef, mAccRec, mAccStdRec, mAccInt, mAccStdInt, tTrainTime, tIntTime);
