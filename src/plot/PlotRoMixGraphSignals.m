function PlotRoMixGraphSignals(sPlotParams, sPreset, sDataset, sKernelParams, mSigRecPhi, mSigInt, mSigCnvrtRec, mSigCnvrtInt, C)
if sPlotParams.b_globalPlotEnable
    ...
    if sPreset.b_runGraphSignals
        PlotGraphSignalsWrapper(sPlotParams, sPreset, sKernelParams, sDataset, ...
            mSigCnvrtRecRef, mSigCnvrtIntRef, mSigCnvrtRec, mSigCnvrtInt, mSigRecPhi, mSigInt, C, 'RoMix')
    end
